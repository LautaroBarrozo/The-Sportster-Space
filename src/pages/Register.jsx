...
export const Register = () => {
  ...
  const register_input_info = (e) =>{
    e.preventDefault()
    const form = e.target

    if (formValidation(Name, Email, password, ConfirmPassword, form)) {
    ...
    <Center>
      ...
      <Login_form_register className="column_form" id="form" onSubmit={register_input_info} novalidate>
          ...
          <Input_container>
              ...
              {Error && <Error_message value={Name}></Error_message>}
          </Input_container>
          ...
          <Input_container>
              ...
              {Error && <Error_message value={Email}></Error_message>}
          </Input_container>
          ...
          <Input_container>
              ...
              {Error && <Error_message value={password}></Error_message>}
          </Input_container>
          ...
          <Form_p>¿Ya tienes una cuenta? <Form_a href="/index.html">Inicia sesion</Form_a></Form_p>
